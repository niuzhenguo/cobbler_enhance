...
urlpatterns = patterns('',
    ...
    (r'^(?P<what>\w+)/console/(?P<obj_name>.+)$', generic_console),
    (r'^(?P<what>\w+)/bios/(?P<obj_name>.+)$', generic_bios),
    (r'^(?P<what>\w+)/pxe/(?P<obj_name>.+)$', generic_pxe),
    (r'^(?P<what>\w+)/enpxe/(?P<obj_name>.+)$', generic_enpxe),
    (r'^(?P<what>\w+)/rebuild/(?P<obj_name>.+)$', generic_rebuild),
    (r'^(?P<what>\w+)/power/(?P<obj_name>.+)$', generic_power),
